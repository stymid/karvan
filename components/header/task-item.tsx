...
import { ArrowSquareDownIcon } from "../icons/arrow-square-down-icon";
    ...
    <>
      ...
      >
        <DropdownTrigger>
          <Button
            size="sm"
            startContent={<ArrowSquareDownIcon className="fill-white" />}
            variant="bordered"
          >
        ...
        <DropdownMenu
          ...
          variant="faded"
        >
          <DropdownSection title="اقدامات">
            <DropdownItem
              key="new_project"
              description="یک پروژه جدید ایجاد کنید."
              shortcut="⌘N"
              startContent={
                <PresentationGraphIcon className="fill-black dark:fill-white" />
              }
            >
              ایجاد پروژه
            </DropdownItem>
            <DropdownItem
              key="new_task"
              description="یک تسک جدید ایجاد کنید."
              shortcut="⌘C"
          ...
          <DropdownSection title="کارهای خطیر">
            <DropdownItem
              key="delete"
